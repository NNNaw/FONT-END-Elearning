...
import { layDanhSachKhoaHocAction, layDanhMucKhoaHocAction, themKhoaHocAction, xoaKhoaHocAction, capNhatKhoaHocAction } from '../../Redux/Actions/QuanLyKhoaHocAction';
import { layDanhSachNguoiDungAction, layDanhSachLoaiNguoiDungAction, themNguoiDungAction, xoaNguoiDungAction } from '../../Redux/Actions/QuanLyNguoiDungAction';
        ...
        if (this.state.btnAdd) {
            return (
                <table className="table text-center">
                    ...
                    <tbody>
                        {this.renderListPersonal(this.props.mangNguoiDung)}
                    </tbody>
                    <tfoot>
                        <tr>
                            <th>STT</th>
            ...
            return (
                <table className="table text-center">
                    ...
                    <tbody>
                        {this.renderListCourse(this.props.mangKhoaHoc)}
                ...
                <div>
                    <div className="modal-body">
                        ...
                        <div className="form-group row">
                            ...
                            <div className="col-sm-8">
                                <input type="text" className="form-control" id='hinhAnh' name='hinhAnh' value={this.state.khoaHoc.hinhAnh} onChange={this.handleChange} />
                            </div>
                        </div>
                        <div className="form-group row">
                    ...
                    <div className="modal-footer">
                        ...
                        <button type="button" className="btn btn-primary" onClick={() => this.props.themKhoaHoc(this.state.khoaHoc, this.clearField)}>Thêm</button>
